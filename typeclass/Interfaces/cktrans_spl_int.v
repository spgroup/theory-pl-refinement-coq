...
Class CKTrans (F A AM ck Conf: Type): Type :=
{
  ...
  eqCK:
    forall ck1: ck, equivalentCKs ck1 ck1 /\
      (forall ck1 ck2: ck, equivalentCKs ck1 ck2 -> equivalentCKs ck2 ck1) /\
         (forall ck1 ck2 ck3: ck, equivalentCKs ck1 ck2 /\ equivalentCKs ck2 ck3 -> equivalentCKs ck1 ck3);
  weakerEqReflexive: 
    forall (fm: F) (ck1: ck), weakerEqCK fm ck1 ck1;
  weakerEqSymmetric:
